...
function ActorDiscriminator(env::AbstractEnv;γ::Float32=Float32(0.99),l::Vector{Int64}=[64,64])
...
###Construct appropriate networks
function ActorDiscriminator(env::AbstractEnv,𝒫::ActorCriticPolicy;γ::Float32=Float32(0.99),l::Vector{Int64}=[64,64])
    out_size = DomainSets.dimension(RLBase.action_space(env))
    in_size = DomainSets.dimension(RLBase.state_space(env))
...
function AIRL(env::AbstractEnv,
    ...
    for iter in 1:iterations
        ...
        for epoch in 1:epochs ÷ train_ratio
